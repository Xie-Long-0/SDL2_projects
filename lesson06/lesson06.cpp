...
int Init()
{
    ...
    Window =
        SDL_CreateWindow("SDL2 第六课 DXkite", 100, 100, 400, 300,
                         SDL_WINDOW_SHOWN);
    ...
    while (true)
    {
        ...
        while (SDL_PollEvent(&event))
        {
            ...
            if (event.type == SDL_KEYDOWN)
                ...
                {
                    BiltTexture(0, 0,
                                Text("UNKNOW", 40, Render, Fonts, 255,
                                     255), Render);
                    break;
